...
def test_trade(gui):
	...
	gui.trigger('buy_sell_goods', 'inventory_entry_3/action')
	...
	gui.trigger('buy_sell_goods', 'size_5/action')
	gui.trigger('buy_sell_goods', 'inventory_entry_0/action')
	...
	# first transfer one
	gui.trigger('buy_sell_goods', 'size_1/action')
	gui.trigger('buy_sell_goods', 'buy_sell_inventory_True_entry_1/action')
	...
	gui.trigger('buy_sell_goods', 'size_2/action')
	gui.trigger('buy_sell_goods', 'buy_sell_inventory_True_entry_1/action')
