...
class Build(object):
	...
	def __call__(self, issuer):
		...
		"""
		game.main.game.world.buildings.append(game.main.game.entities.buildings[self.building](self.x, self.y, issuer, self.instance if issuer == game.main.game.world.player else None))
