...
# this trick is for setting RELEASE_VERSION if the code is cloned
# from git repository
...
class _build_i18n(distutils.cmd.Command):
    ...
    user_options = [
        ...
        ('text-domains=', None, 'list of pairs of gettext domains & directory'
                                ' that holds the i18n files'),
    ...
    def run(self):
        ...
        NOTE: This code is partly broken and hack-fixed to the state where
        it appears to work.
        It should be removed, since nobody understands the code well enough
        ...
        # Since specifying a .mofile dir is not supported,
        # we manually move build/mo/
        ...
        if os.path.exists(os.path.join("build", "mo")):
            ...
            copytree(os.path.join("build", "mo"), os.path.join("content",
                                                               "lang"))
