...
class LandManager(WorldObject):
	...
	def refresh_resource_deposits(self):
		...
		for resource_id, building_ids in {RES.RAW_CLAY_ID: [BUILDINGS.CLAY_DEPOSIT, BUILDINGS.CLAY_PIT], RES.RAW_IRON_ID: [BUILDINGS.MOUNTAIN, BUILDINGS.IRON_MINE]}.iteritems():
