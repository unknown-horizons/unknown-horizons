	...
	* last_collector_improvement_road: the last tick when a new road connection was built to improve collector coverage
	...
	def display(self):
		...
		tile_colors = {
			...
			BUILDING_PURPOSE.CANNON_FOUNDRY:  ( 10,  10,  10),
			BUILDING_PURPOSE.BLENDER:         ( 13,  13,  13),
			BUILDING_PURPOSE.PUBLIC_BATH:     ( 20,  20,  20),
		}
	...
	production_building_classes = set([BUILDINGS.FISHER, BUILDINGS.LUMBERJACK, BUILDINGS.FARM, BUILDINGS.CLAY_PIT,
		...
		BUILDINGS.WINDMILL, BUILDINGS.BAKERY, BUILDINGS.WINERY, BUILDINGS.BREWERY, BUILDINGS.CANNON_FOUNDRY,
		BUILDINGS.BLENDER, BUILDINGS.PUBLIC_BATH])
