...
class ToolmakerEvaluator(BuildingEvaluator):
	def __init__(self, area_builder, builder, distance_to_smeltery, distance_to_charcoal_burner, distance_to_lumberjack, distance_to_collector, alignment):
		...
		distance = self._weighted_sum(distance_to_collector, [(0.4, distance_to_smeltery), (0.4, distance_to_charcoal_burner), (0.1, distance_to_lumberjack)])
		self.value = float(Entities.buildings[BUILDINGS.TOOLMAKER_CLASS].radius) / distance + alignment * 0.02
