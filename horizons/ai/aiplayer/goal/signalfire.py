...
class SignalFireGoal(SettlementGoal):
    ...
    @property
    def active(self):
        return super(SignalFireGoal, self).active and not \
            self.settlement.count_buildings(BUILDINGS.SIGNAL_FIRE)

    def execute(self):
        result = AbstractBuilding.buildings[BUILDINGS.SIGNAL_FIRE].build(
