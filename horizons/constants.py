...
#?		RES.LAMB_WOOL:      BUILDINGS.PASTURE,
		RES.POTATOES:       BUILDINGS.POTATO_FIELD,
		RES.RAW_SUGAR:      BUILDINGS.SUGARCANE_FIELD,
	##	RES.RAW_CLAY:       BUILDINGS.CLAY_PIT,
	##	RES.RAW_IRON:       BUILDINGS.IRON_MINE,
		RES.TOBACCO_PLANTS: BUILDINGS.TOBACCO_FIELD,
#?		RES.CATTLE:         BUILDINGS.CATTLE_RUN,
		RES.HERBS:          BUILDINGS.HERBARY,
		RES.GRAIN:          BUILDINGS.CORN_FIELD,
		RES.SPICE_PLANTS:   BUILDINGS.SPICE_FIELD,
	##	RES.STONE_DEPOSIT:  BUILDINGS.STONE_PIT,
		RES.COCOA_BEANS:    BUILDINGS.COCOA_FIELD,
