...
class GROUND:
	...
	MOUNTAIN_TOP_PEAK_T_STRAIGHT_NORTH = (8, "T_peak_straight", 225)
	MOUNTAIN_TOP_PEAK_T_STRAIGHT_WEST = (8, "T_peak_straight", 135)
	...
	MOUNTAIN_TOP_NORTHWEST_NORTHEAST_SOUTHEAST = (8, "curve_3", 45)
	MOUNTAIN_TOP_SOUTHWEST_NORTHWEST_NORTHEAST = (8, "curve_3", 315)
	MOUNTAIN_TOP_SOUTHEAST_SOUTHWEST_NORTHWEST = (8, "curve_3", 225)
