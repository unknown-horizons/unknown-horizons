...
class PlayersOverview(StatsWidget):
	...
	def _add_line_to_gui(self, player):
		...
		resource_score = widgets.Label(name = 'resource_score_{0:d}'.format(player.worldid))
		resource_score.text = unicode(stats.resource_score)
		resource_score.min_size = (90, 20)

		building_score = widgets.Label(name = 'building_score_{0:d}'.format(player.worldid))
