...
GAMEPLAY_TIPS = {
	...
	'items': [
	    ...
	    _("You can increase the happiness of your citizens by lowering the taxes."),
	    _("Build firestations and doctors to protect your citizens from fire and disease."),
