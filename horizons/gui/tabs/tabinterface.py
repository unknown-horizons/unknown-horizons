...
class TabInterface(object):
	...
	def __init__(self, widget = None, **kwargs):
		...
		self.button_up_image = 'content/gui/icons/tabwidget/tab.png' # TabButtons upimage
		self.button_down_image = 'content/gui/icons/tabwidget/tab.png' # TabButtons downimage
		self.button_hover_image = 'content/gui/icons/tabwidget/tab2.png' # TabButtons hoverimage
		self.button_active_image = 'content/gui/icons/tabwidget/tab.png' # TabButtons active image
		self.button_background_image = 'content/gui/icons/tabwidget/tab.png' # TabButtons background image
